...
extern "C" void PopulateDebugHeaders()
{
    ...
    MAKE_TYPE_ENTRY(ThreadBuffer);
    MAKE_FIELD_ENTRY(ThreadBuffer, m_pNext);
    MAKE_FIELD_ENTRY(ThreadBuffer, m_rgbAllocContextBuffer);
    MAKE_FIELD_ENTRY(ThreadBuffer, m_threadId);
    MAKE_FIELD_ENTRY(ThreadBuffer, m_pThreadStressLog);
    MAKE_FIELD_ENTRY(ThreadBuffer, m_pExInfoStackHead);
